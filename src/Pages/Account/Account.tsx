      ...
      <div className="order_content">
        <div className="my_order_head">
          <div className="btn_overview">
            <Link to="/account" style={{ textDecoration: "none", color: "#14cda8",fontWeight:700}}>
              Overview
            </Link>
          </div>
...
<div className='account_profile'>
      ...
      <div className='link_order_wishlist_myntra'>
        <div className='check_order_status'>
            <img src='https://constant.myntassets.com/mymyntra/assets/img/profile-orders.png'/>
            <p>Orders</p>
            <span>Check your order status</span>
        </div>

        <div className='check_collection_status'>
            <img src='https://constant.myntassets.com/mymyntra/assets/img/profile-collections.png'/>
      ...
      <div className='link_order_wishlist_myntra'>
        <div className='check_order_status'>
            <img src='https://constant.myntassets.com/mymyntra/assets/img/profile-myntrapoints.png'/>
            <p>MynCash</p>
        ...
        <div className='check_collection_status'>
            <img src='https://constant.myntassets.com/mymyntra/assets/img/profile-cards.png'/>
            <p>Saved Cards</p>
            <span>Save your cards for faster checkout</span>
        </div>

        <div className='check_myntra_credits'>
            <img src='https://constant.myntassets.com/mymyntra/assets/img/upiIcon.png'/>
            <p>Saved UPI</p>
      ...
      <div className='link_order_wishlist_myntra'>
        <div className='check_order_status'>
            <img src='https://constant.myntassets.com/mymyntra/assets/img/wallets_bnpl.png'/>
            <p>Wallets/BNPL</p>
            <span>View your saved wallets and BNPL</span>
        </div>

        <div className='check_collection_status'>
            <img src='https://constant.myntassets.com/mymyntra/assets/img/profile-address.png'/>
            <p>Addresses</p>
            <span>Save addresses for hassel free checkout</span>
        </div>

        <div className='check_myntra_credits'>
            <img src='https://constant.myntassets.com/mymyntra/assets/img/profile-coupons.png'/>
            <p>Coupons</p>
      ...
      <div className='link_order_wishlist_myntra'>
        <div className='check_order_status'>
            <img src='https://constant.myntassets.com/mymyntra/assets/img/profile-edit.png'/>
            <p>Profile Details</p>
